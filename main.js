...
function Mike(game, mikesStuff) {
    this.front =  new Animation(mikesStuff[0], 30, 70, 7, 0.12, 7, true, 2);
    this.back = new Animation(mikesStuff[1], 30, 70, 7, 0.12, 7, true, 2)
    this.speed = 55;
    this.ctx = game.ctx;
    Entity.call(this, game, 450, 300);
}

Mike.prototype = new Entity();
Mike.prototype.constructor = Mike;

Mike.prototype.draw = function () {
    if (this.game.d) {
        this.front.drawFrame(this.game.clockTick, this.ctx, this.x, this.y);
    }
    else if (this.game.a) {
        this.back.drawFrame(this.game.clockTick, this.ctx, this.x, this.y);
    }
    else {
        this.front.drawFrame(this.game.clockTick, this.ctx, this.x, this.y)
    }
...
AM.queueDownload("./img/moonwalk.png");
AM.queueDownload("./img/moonwalkback.png");
...
AM.downloadAll(function () {
    ...
    var mikesStuff = [AM.getAsset("./img/moonwalk.png"), AM.getAsset("./img/moonwalkback.png")];
    ...
    gameEngine.addEntity(new Mike(gameEngine, mikesStuff));
